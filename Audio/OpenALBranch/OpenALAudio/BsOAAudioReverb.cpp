...
namespace bs 
{
	...
	void OAAudioReverb::setEarlyDelay(float delay)
	{

	}

	void OAAudioReverb::setLateDelay(float delay)
	{
	...
	void OAAudioReverb::setHFDecayRatio(float ratio)
	{
	...
	void OAAudioReverb::setLowShelfFrequencies(float freq)
	{

	}

	void OAAudioReverb::setLowShelfGain(float gain)
	{
