...
namespace bs
{
	...
	public:
		...
		/** Registers a new AudioReverb. Should be called on reverb creation. */
		void _registerReverb(OAAudioReverb* reverb); // Add New

		/** Unregisters an existing AudioReverb. Should be called before reverb destruction. */
		void _unregisterReverb(OAAudioReverb* reverb); // Add New
