...
namespace bs
{
	...
	struct AUDIO_CLIP_DESC
	{
		...
		/** Determines if the clip is an impulse response for convolution reverb. */
		bool isIR = false; // Add New
	...
	public:
		...
		/** Determines if the clip is used for convolution reverb. */
		BS_SCRIPT_EXPORT(n:IsIR,pr:getter)
		bool isIR() const { return mDesc.isIR; } // Add New
